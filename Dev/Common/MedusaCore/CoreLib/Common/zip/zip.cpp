...
#    endif /* !NO_ADDFILEINEXISTINGZIP*/
 ...
 zipFile  zipOpen2 (const char *pathname, int append, zipcharpc* globalcomment, zlib_filefunc_def* pzlib_filefunc32_def)
{
 ...
 int  zipWriteInFileInZip (zipFile file,const void* buf,unsigned int len)
{
    ...
    zi->ci.crc32 = crc32((uLong)zi->ci.crc32,(const Bytef*)buf,(uInt)len);
