...
bool operator<(const TClass& val)const{return P1<val.P1;}	\
intp GetHashCode()const{return HashUtility::Hash(P1);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5&&P6<val.P6;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5)^HashUtility::Hash(P6);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5&&P6<val.P6&&P7<val.P7;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5)^HashUtility::Hash(P6)^HashUtility::Hash(P7);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5&&P6<val.P6&&P7<val.P7&&P8<val.P8;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5)^HashUtility::Hash(P6)^HashUtility::Hash(P7)^HashUtility::Hash(P8);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5&&P6<val.P6&&P7<val.P7&&P8<val.P8&&P9<val.P9;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5)^HashUtility::Hash(P6)^HashUtility::Hash(P7)^HashUtility::Hash(P8)^HashUtility::Hash(P9);}	\
};
...
bool operator<(const TClass& val)const{return P1<val.P1&&P2<val.P2&&P3<val.P3&&P4<val.P4&&P5<val.P5&&P6<val.P6&&P7<val.P7&&P8<val.P8&&P9<val.P9&&P10<val.P10;}	\
intp GetHashCode()const{return HashUtility::Hash(P1)^HashUtility::Hash(P2)^HashUtility::Hash(P3)^HashUtility::Hash(P4)^HashUtility::Hash(P5)^HashUtility::Hash(P6)^HashUtility::Hash(P7)^HashUtility::Hash(P8)^HashUtility::Hash(P9)^HashUtility::Hash(P10);}	\
};
