...
namespace Pattern
{
	...
	class ReverseAction:public BaseFiniteAction<TTarget>
	{
	public:
		ReverseAction(BaseFiniteAction<TTarget>* innerAction):BaseFiniteAction(innerAction->GetDuration()),mInnerAction(innerAction){}
