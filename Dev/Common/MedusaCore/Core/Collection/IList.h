...
public:
	...
	inline bool RemoveFirst(TParameterType val){ return RemoveFirst(0,this->mCount,val);}
	...
	inline bool RemoveLast(TParameterType val){ return RemoveLast(0,this->mCount,val);}
	...
	inline void RemoveAll(TParameterType val){ RemoveAll(0,this->mCount,val);}
