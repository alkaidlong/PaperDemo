...
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::Zero(0,0,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::One(1,1,1,1);
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::UnitX(1,0,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::UnitY(0,1,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::UnitZ(0,0,1,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::UnitW(0,0,0,1);



template<typename T>
WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::Min(Math::Values<T>::Min,Math::Values<T>::Min,Math::Values<T>::Min);

template<typename T>
WEAK_MULTIPLE_DEFINE const Point4<T> Point4<T>::Max(Math::Values<T>::Max,Math::Values<T>::Max,Math::Values<T>::Max);
