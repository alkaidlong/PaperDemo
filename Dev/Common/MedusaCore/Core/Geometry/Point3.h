...
public:
	...
	template<typename T1>
	float operator*(const Point3<T1>& point)const{return X*point.X+Y*point.Y+Z*point.Z;}
	...
	template<typename T1>
	float GetAngle(const Point3<T1>& point)const
	{
		Point3 a=*this;
		a.Normalize();
		Point3<T1> b=point;
	...
	{
		float dot=Dot(point);
		return point*dot/point.LengthSquare();
	}
...
template<typename T>
WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Zero(0,0,0);

template<typename T>
WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::One(1,1,1);

template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::UnitX(1,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::UnitY(0,1,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::UnitZ(0,0,1);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Up(0,1,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Down(0,-1,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Right(1,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Left(-1,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::ForWard(0,0,-1);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Backward(0,0,1);

template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Half(0.5,0.5,0.5);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::HalfX(0.5,0,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::HalfY(0,0.5,0);
template<typename T> WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::HalfZ(0,0,0.5);



template<typename T>
WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Min(Math::Values<T>::Min,Math::Values<T>::Min,Math::Values<T>::Min);

template<typename T>
WEAK_MULTIPLE_DEFINE const Point3<T> Point3<T>::Max(Math::Values<T>::Max,Math::Values<T>::Max,Math::Values<T>::Max);
