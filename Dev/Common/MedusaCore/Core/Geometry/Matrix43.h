...
public:
	...
	inline Matrix43(const float* items)
	{
...
public:
	...
	Matrix43& RotateX(float angle);
	Matrix43& RotateY(float angle);
	Matrix43& RotateZ(float angle);
	...
	static Matrix43 CreateRotateX(float angle);
	static Matrix43 CreateRotateY(float angle);
	static Matrix43 CreateRotateZ(float angle);
	static Matrix43 CreateRotateAxis(const Point3F& axis,float angle);
