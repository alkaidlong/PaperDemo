...
Matrix3 Matrix3::CreateRotateX( float angle )
{
	float cosX=Math::Cos(angle);
	float sinX=Math::Sin(angle);
...
Matrix3 Matrix3::CreateRotateY( float angle )
{
	float cosY=Math::Cos(angle);
	float sinY=Math::Sin(angle);
...
Matrix3 Matrix3::CreateRotateZ( float angle )
{
	float cosZ=Math::Cos(angle);
	float sinZ=Math::Sin(angle);
...
Matrix3 Matrix3::CreateRotateAxis( const Point3F& axis,float angle )
{
