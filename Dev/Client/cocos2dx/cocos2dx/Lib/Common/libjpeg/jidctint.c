 ...
 * intermediate JPEG_INT32 array would be needed.)
 *
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < DCTSIZE; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z2 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    z3 = (JPEG_INT32) wsptr[4];
...
jpeg_idct_7x7 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp10, tmp11, tmp12, tmp13;
  JPEG_INT32 z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
  ...
  for (ctr = 0; ctr < 7; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp13 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp13 <<= CONST_BITS;

    z1 = (JPEG_INT32) wsptr[2];
    z2 = (JPEG_INT32) wsptr[4];
    z3 = (JPEG_INT32) wsptr[6];
    ...
    z1 = (JPEG_INT32) wsptr[1];
    z2 = (JPEG_INT32) wsptr[3];
    z3 = (JPEG_INT32) wsptr[5];
...
jpeg_idct_6x6 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp10, tmp11, tmp12;
  JPEG_INT32 z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
  ...
  for (ctr = 0; ctr < 6; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp0 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp0 <<= CONST_BITS;
    tmp2 = (JPEG_INT32) wsptr[4];
    tmp10 = MULTIPLY(tmp2, FIX(0.707106781));   /* c4 */
    tmp1 = tmp0 + tmp10;
    tmp11 = tmp0 - tmp10 - tmp10;
    tmp10 = (JPEG_INT32) wsptr[2];
    tmp0 = MULTIPLY(tmp10, FIX(1.224744871));   /* c2 */
    tmp10 = tmp1 + tmp0;
    tmp12 = tmp1 - tmp0;
...
jpeg_idct_5x5 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp10, tmp11, tmp12;
  JPEG_INT32 z1, z2, z3;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
  ...
  for (ctr = 0; ctr < 5; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp12 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp12 <<= CONST_BITS;
    tmp0 = (JPEG_INT32) wsptr[2];
    tmp1 = (JPEG_INT32) wsptr[4];
    z1 = MULTIPLY(tmp0 + tmp1, FIX(0.790569415)); /* (c2+c4)/2 */
    z2 = MULTIPLY(tmp0 - tmp1, FIX(0.353553391)); /* (c2-c4)/2 */
    z3 = tmp12 + z2;
    tmp10 = z3 + z1;
...
jpeg_idct_2x2 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp4, tmp5;
  ISLOW_MULT_TYPE * quantptr;
  JSAMPROW outptr;
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  SHIFT_TEMPS
...
jpeg_idct_9x9 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp10, tmp11, tmp12, tmp13, tmp14;
...
jpeg_idct_10x10 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24;
  ...
  for (ctr = 0; ctr < 10; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z3 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    z3 <<= CONST_BITS;
    z4 = (JPEG_INT32) wsptr[4];
    z1 = MULTIPLY(z4, FIX(1.144122806));         /* c4 */
    z2 = MULTIPLY(z4, FIX(0.437016024));         /* c8 */
    tmp10 = z3 + z1;
    tmp11 = z3 - z2;
...
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
  ...
  for (ctr = 0; ctr < 11; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp10 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp10 <<= CONST_BITS;
...
jpeg_idct_12x12 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
...
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
  ...
  for (ctr = 0; ctr < 13; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    z1 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    z1 <<= CONST_BITS;

    z2 = (JPEG_INT32) wsptr[2];
    z3 = (JPEG_INT32) wsptr[4];
    z4 = (JPEG_INT32) wsptr[6];
...
jpeg_idct_14x14 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
...
{
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp27;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
  int * wsptr;
...
jpeg_idct_16x16 (j_decompress_ptr cinfo, jpeg_component_info * compptr,
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp10, tmp11, tmp12, tmp13;
  JPEG_INT32 tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp27;
  JPEG_INT32 z1, z2, z3, z4;
  JCOEFPTR inptr;
  ISLOW_MULT_TYPE * quantptr;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  JPEG_INT32 workspace[4*2];	/* buffers data between passes */
  SHIFT_TEMPS
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 14; ctr++) {
    ...
    /* Add fudge factor here for final descale. */
    tmp23 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp23 <<= CONST_BITS;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 12; ctr++) {
    ...
    tmp10 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp10 <<= CONST_BITS;
    tmp12 = (JPEG_INT32) wsptr[4];
    tmp20 = MULTIPLY(tmp12, FIX(0.707106781));   /* c4 */
    tmp11 = tmp10 + tmp20;
    tmp21 = tmp10 - tmp20 - tmp20;
    tmp20 = (JPEG_INT32) wsptr[2];
    tmp10 = MULTIPLY(tmp20, FIX(1.224744871));   /* c2 */
    tmp20 = tmp11 + tmp10;
    tmp22 = tmp11 - tmp10;
		...
		JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = 0; ctr < 10; ctr++) {
    ...
    tmp12 = (JPEG_INT32) wsptr[0] + (ONE << (PASS1_BITS+2));
    tmp12 <<= CONST_BITS;
    tmp13 = (JPEG_INT32) wsptr[2];
    tmp14 = (JPEG_INT32) wsptr[4];
    z1 = MULTIPLY(tmp13 + tmp14, FIX(0.790569415)); /* (c2+c4)/2 */
    z2 = MULTIPLY(tmp13 - tmp14, FIX(0.353553391)); /* (c2-c4)/2 */
    z3 = tmp12 + z2;
    tmp10 = z3 + z1;
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  JSAMPLE *range_limit = IDCT_range_limit(cinfo);
  int ctr;
  JPEG_INT32 workspace[2*4];	/* buffers data between passes */
  SHIFT_TEMPS
