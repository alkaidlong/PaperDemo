 ...
 * in-place in that buffer.  Type DCTELEM is int for 8-bit samples, JPEG_INT32
...
#define MULTIPLY16C16(var,const)  (((JPEG_INT16) (var)) * ((JPEG_INT16) (const)))
#endif
#ifdef SHORTxLCONST_32		/* known to work with Microsoft C 6.0 */
#define MULTIPLY16C16(var,const)  (((JPEG_INT16) (var)) * ((JPEG_INT32) (const)))
#endif
...
#ifdef SHORTxSHORT_32		/* may work if 'int' is 32 bits */
#define MULTIPLY16V16(var1,var2)  (((JPEG_INT16) (var1)) * ((JPEG_INT16) (var2)))
#endif
