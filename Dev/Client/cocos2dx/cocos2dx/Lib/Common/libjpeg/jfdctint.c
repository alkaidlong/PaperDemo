...
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp4;
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13;
  JPEG_INT32 z1, z2;
  DCTELEM workspace[8];
  DCTELEM *dataptr;
...
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6;
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15;
  JPEG_INT32 z1, z2;
...
{
  JPEG_INT32 tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7;
  JPEG_INT32 tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17;
