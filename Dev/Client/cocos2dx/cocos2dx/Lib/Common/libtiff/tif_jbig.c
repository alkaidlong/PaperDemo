...
static int JBIGDecode(TIFF* tif, TIFF_UINT8_T* buffer, tmsize_t size, TIFF_UINT16_T s)
{
...
static int JBIGCopyEncodedData(TIFF* tif, unsigned char* pp, size_t cc, TIFF_UINT16_T s)
{
	(void) s;
	while (cc > 0)
	{
...
static int JBIGEncode(TIFF* tif, TIFF_UINT8_T* buffer, tmsize_t size, TIFF_UINT16_T s)
{
