...
int
_TIFFMergeFields(TIFF* tif, const TIFFField info[], TIFF_UINT32_T n)
{
...
const TIFFField*
TIFFFindField(TIFF* tif, TIFF_UINT32_T tag, TIFFDataType dt)
{
...
const TIFFField*
TIFFFieldWithTag(TIFF* tif, TIFF_UINT32_T tag)
{
...
const TIFFField*
_TIFFFindOrRegisterField(TIFF *tif, TIFF_UINT32_T tag, TIFFDataType dt)
...
TIFFField*
_TIFFCreateAnonField(TIFF *tif, TIFF_UINT32_T tag, TIFFDataType field_type)
{
	TIFFField *fld;
	(void) tif;
...
int
TIFFMergeFieldInfo(TIFF* tif, const TIFFFieldInfo info[], TIFF_UINT32_T n)
{
