 ...
 * 	with TIFF_UINT16_T. We recommend 2K.
...
typedef struct {
	...
	TIFF_UINT64_T file_size;
	TIFF_UINT32_T image_width;
	TIFF_UINT32_T image_length;
	TIFF_UINT32_T strile_width;
	TIFF_UINT32_T strile_length;
	TIFF_UINT32_T strile_length_total;
	TIFF_UINT8_T samples_per_pixel;
	TIFF_UINT8_T plane_sample_offset;
	TIFF_UINT8_T samples_per_pixel_per_plane;
	TIFF_UINT64_T jpeg_interchange_format;
	TIFF_UINT64_T jpeg_interchange_format_length;
	TIFF_UINT8_T jpeg_proc;
	TIFF_UINT8_T subsamplingcorrect;
	TIFF_UINT8_T subsamplingcorrect_done;
	TIFF_UINT8_T subsampling_tag;
	TIFF_UINT8_T subsampling_hor;
	TIFF_UINT8_T subsampling_ver;
	TIFF_UINT8_T subsampling_force_desubsampling_inside_decompression;
	TIFF_UINT8_T qtable_offset_count;
	TIFF_UINT8_T dctable_offset_count;
	TIFF_UINT8_T actable_offset_count;
	TIFF_UINT64_T qtable_offset[3];
	TIFF_UINT64_T dctable_offset[3];
	TIFF_UINT64_T actable_offset[3];
	TIFF_UINT8_T* qtable[4];
	TIFF_UINT8_T* dctable[4];
	TIFF_UINT8_T* actable[4];
	TIFF_UINT16_T restart_interval;
	TIFF_UINT8_T restart_index;
	TIFF_UINT8_T sof_log;
	TIFF_UINT8_T sof_marker_id;
	TIFF_UINT32_T sof_x;
	TIFF_UINT32_T sof_y;
	TIFF_UINT8_T sof_c[3];
	TIFF_UINT8_T sof_hv[3];
	TIFF_UINT8_T sof_tq[3];
	TIFF_UINT8_T sos_cs[3];
	TIFF_UINT8_T sos_tda[3];
	struct {
		TIFF_UINT8_T log;
		OJPEGStateInBufferSource in_buffer_source;
		TIFF_UINT32_T in_buffer_next_strile;
		TIFF_UINT64_T in_buffer_file_pos;
		TIFF_UINT64_T in_buffer_file_togo;
	} sos_end[3];
	TIFF_UINT8_T readheader_done;
	TIFF_UINT8_T writeheader_done;
	TIFF_UINT16_T write_cursample;
	TIFF_UINT32_T write_curstrile;
	TIFF_UINT8_T libjpeg_session_active;
	TIFF_UINT8_T libjpeg_jpeg_query_style;
	jpeg_error_mgr libjpeg_jpeg_error_mgr;
	jpeg_decompress_struct libjpeg_jpeg_decompress_struct;
	jpeg_source_mgr libjpeg_jpeg_source_mgr;
	TIFF_UINT8_T subsampling_convert_log;
	TIFF_UINT32_T subsampling_convert_ylinelen;
	TIFF_UINT32_T subsampling_convert_ylines;
	TIFF_UINT32_T subsampling_convert_clinelen;
	TIFF_UINT32_T subsampling_convert_clines;
	TIFF_UINT32_T subsampling_convert_ybuflen;
	TIFF_UINT32_T subsampling_convert_cbuflen;
	TIFF_UINT32_T subsampling_convert_ycbcrbuflen;
	TIFF_UINT8_T* subsampling_convert_ycbcrbuf;
	TIFF_UINT8_T* subsampling_convert_ybuf;
	TIFF_UINT8_T* subsampling_convert_cbbuf;
	TIFF_UINT8_T* subsampling_convert_crbuf;
	TIFF_UINT32_T subsampling_convert_ycbcrimagelen;
	TIFF_UINT8_T** subsampling_convert_ycbcrimage;
	TIFF_UINT32_T subsampling_convert_clinelenout;
	TIFF_UINT32_T subsampling_convert_state;
	TIFF_UINT32_T bytes_per_line;   /* if the codec outputs subsampled data, a 'line' in bytes_per_line */
	TIFF_UINT32_T lines_per_strile; /* and lines_per_strile means subsampling_ver desubsampled rows     */
	OJPEGStateInBufferSource in_buffer_source;
	TIFF_UINT32_T in_buffer_next_strile;
	TIFF_UINT32_T in_buffer_strile_count;
	TIFF_UINT64_T in_buffer_file_pos;
	TIFF_UINT8_T in_buffer_file_pos_log;
	TIFF_UINT64_T in_buffer_file_togo;
	TIFF_UINT16_T in_buffer_togo;
	TIFF_UINT8_T* in_buffer_cur;
	TIFF_UINT8_T in_buffer[OJPEG_BUFFER];
	OJPEGStateOutState out_state;
	TIFF_UINT8_T out_buffer[OJPEG_BUFFER];
	TIFF_UINT8_T* skip_buffer;
} OJPEGState;

static int OJPEGVGetField(TIFF* tif, TIFF_UINT32_T tag, va_list ap);
static int OJPEGVSetField(TIFF* tif, TIFF_UINT32_T tag, va_list ap);
static void OJPEGPrintDir(TIFF* tif, FILE* fd, long flags);

static int OJPEGFixupTags(TIFF* tif);
static int OJPEGSetupDecode(TIFF* tif);
static int OJPEGPreDecode(TIFF* tif, TIFF_UINT16_T s);
static int OJPEGPreDecodeSkipRaw(TIFF* tif);
static int OJPEGPreDecodeSkipScanlines(TIFF* tif);
static int OJPEGDecode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc, TIFF_UINT16_T s);
static int OJPEGDecodeRaw(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc);
static int OJPEGDecodeScanlines(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc);
static void OJPEGPostDecode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc);
static int OJPEGSetupEncode(TIFF* tif);
static int OJPEGPreEncode(TIFF* tif, TIFF_UINT16_T s);
static int OJPEGEncode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc, TIFF_UINT16_T s);
static int OJPEGPostEncode(TIFF* tif);
static void OJPEGCleanup(TIFF* tif);

static void OJPEGSubsamplingCorrect(TIFF* tif);
static int OJPEGReadHeaderInfo(TIFF* tif);
static int OJPEGReadSecondarySos(TIFF* tif, TIFF_UINT16_T s);
...
static int OJPEGReadHeaderInfoSecStreamSof(TIFF* tif, TIFF_UINT8_T marker_id);
...
static int OJPEGReadByte(OJPEGState* sp, TIFF_UINT8_T* byte);
static int OJPEGReadBytePeek(OJPEGState* sp, TIFF_UINT8_T* byte);
static void OJPEGReadByteAdvance(OJPEGState* sp);
static int OJPEGReadWord(OJPEGState* sp, TIFF_UINT16_T* word);
static int OJPEGReadBlock(OJPEGState* sp, TIFF_UINT16_T len, void* mem);
static void OJPEGReadSkip(OJPEGState* sp, TIFF_UINT16_T len);

static int OJPEGWriteStream(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamSoi(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamQTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamDcTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamAcTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamDri(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamSof(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamSos(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static int OJPEGWriteStreamCompressed(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamRst(TIFF* tif, void** mem, TIFF_UINT32_T* len);
static void OJPEGWriteStreamEoi(TIFF* tif, void** mem, TIFF_UINT32_T* len);

#ifdef LIBJPEG_ENCAP_EXTERNAL
extern int jpeg_create_decompress_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo);
extern int jpeg_read_header_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, TIFF_UINT8_T require_image);
extern int jpeg_start_decompress_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo);
extern int jpeg_read_scanlines_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* scanlines, TIFF_UINT32_T max_lines);
extern int jpeg_read_raw_data_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* data, TIFF_UINT32_T max_lines);
extern void jpeg_encap_unwind(TIFF* tif);
#else
static int jpeg_create_decompress_encap(OJPEGState* sp, jpeg_decompress_struct* j);
static int jpeg_read_header_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, TIFF_UINT8_T require_image);
static int jpeg_start_decompress_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo);
static int jpeg_read_scanlines_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* scanlines, TIFF_UINT32_T max_lines);
static int jpeg_read_raw_data_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* data, TIFF_UINT32_T max_lines);
...
static int
OJPEGVGetField(TIFF* tif, TIFF_UINT32_T tag, va_list ap)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	switch(tag)
	{
		case TIFFTAG_JPEGIFOFFSET:
			*va_arg(ap,TIFF_UINT64_T*)=(TIFF_UINT64_T)sp->jpeg_interchange_format;
			break;
		case TIFFTAG_JPEGIFBYTECOUNT:
			*va_arg(ap,TIFF_UINT64_T*)=(TIFF_UINT64_T)sp->jpeg_interchange_format_length;
			break;
		case TIFFTAG_YCBCRSUBSAMPLING:
			if (sp->subsamplingcorrect_done==0)
				OJPEGSubsamplingCorrect(tif);
			*va_arg(ap,TIFF_UINT16_T*)=(TIFF_UINT16_T)sp->subsampling_hor;
			*va_arg(ap,TIFF_UINT16_T*)=(TIFF_UINT16_T)sp->subsampling_ver;
			break;
		case TIFFTAG_JPEGQTABLES:
			*va_arg(ap,TIFF_UINT32_T*)=(TIFF_UINT32_T)sp->qtable_offset_count;
			*va_arg(ap,void**)=(void*)sp->qtable_offset; 
			break;
		case TIFFTAG_JPEGDCTABLES:
			*va_arg(ap,TIFF_UINT32_T*)=(TIFF_UINT32_T)sp->dctable_offset_count;
			*va_arg(ap,void**)=(void*)sp->dctable_offset;  
			break;
		case TIFFTAG_JPEGACTABLES:
			*va_arg(ap,TIFF_UINT32_T*)=(TIFF_UINT32_T)sp->actable_offset_count;
			*va_arg(ap,void**)=(void*)sp->actable_offset;
			break;
		case TIFFTAG_JPEGPROC:
			*va_arg(ap,TIFF_UINT16_T*)=(TIFF_UINT16_T)sp->jpeg_proc;
			break;
		case TIFFTAG_JPEGRESTARTINTERVAL:
			*va_arg(ap,TIFF_UINT16_T*)=sp->restart_interval;
			break;
		default:
...
static int
OJPEGVSetField(TIFF* tif, TIFF_UINT32_T tag, va_list ap)
{
	...
	{
		case TIFFTAG_JPEGIFOFFSET:
			sp->jpeg_interchange_format=(TIFF_UINT64_T)va_arg(ap,TIFF_UINT64_T);
			break;
		case TIFFTAG_JPEGIFBYTECOUNT:
			sp->jpeg_interchange_format_length=(TIFF_UINT64_T)va_arg(ap,TIFF_UINT64_T);
			break;
		case TIFFTAG_YCBCRSUBSAMPLING:
			sp->subsampling_tag=1;
			sp->subsampling_hor=(TIFF_UINT8_T)va_arg(ap,uint16_vap);
			sp->subsampling_ver=(TIFF_UINT8_T)va_arg(ap,uint16_vap);
			tif->tif_dir.td_ycbcrsubsampling[0]=sp->subsampling_hor;
			tif->tif_dir.td_ycbcrsubsampling[1]=sp->subsampling_ver;
			break;
		case TIFFTAG_JPEGQTABLES:
			ma=(TIFF_UINT32_T)va_arg(ap,TIFF_UINT32_T);
			if (ma!=0)
			{
				if (ma>3)
				{
				...
				sp->qtable_offset_count=(TIFF_UINT8_T)ma;
				mb=(TIFF_UINT64_T*)va_arg(ap,TIFF_UINT64_T*);
				for (n=0; n<ma; n++)
		...
		case TIFFTAG_JPEGDCTABLES:
			...
			if (ma!=0)
			{
				...
				sp->dctable_offset_count=(TIFF_UINT8_T)ma;
				mb=(TIFF_UINT64_T*)va_arg(ap,TIFF_UINT64_T*);
				for (n=0; n<ma; n++)
		...
		case TIFFTAG_JPEGACTABLES:
			...
			if (ma!=0)
			{
				...
				sp->actable_offset_count=(TIFF_UINT8_T)ma;
				mb=(TIFF_UINT64_T*)va_arg(ap,TIFF_UINT64_T*);
				for (n=0; n<ma; n++)
			...
			break;
		case TIFFTAG_JPEGPROC:
			sp->jpeg_proc=(TIFF_UINT8_T)va_arg(ap,uint16_vap);
			break;
		case TIFFTAG_JPEGRESTARTINTERVAL:
			sp->restart_interval=(TIFF_UINT16_T)va_arg(ap,uint16_vap);
			break;
		default:
...
static int
OJPEGPreDecode(TIFF* tif, TIFF_UINT16_T s)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	TIFF_UINT32_T m;
	if (sp->subsamplingcorrect_done==0)
	...
	{
		sp->plane_sample_offset=(TIFF_UINT8_T)s;
...
static int
OJPEGDecode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc, TIFF_UINT16_T s)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	(void)s;
	if (sp->libjpeg_jpeg_query_style==0)
...
static int
OJPEGDecodeRaw(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc)
{
...
static int
OJPEGDecodeScanlines(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc)
{
...
static void
OJPEGPostDecode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	(void)buf;
	(void)cc;
...
static int
OJPEGPreEncode(TIFF* tif, TIFF_UINT16_T s)
{
...
static int
OJPEGEncode(TIFF* tif, TIFF_UINT8_T* buf, tmsize_t cc, TIFF_UINT16_T s)
{
...
static int
OJPEGReadSecondarySos(TIFF* tif, TIFF_UINT16_T s)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	TIFF_UINT8_T m;
	assert(s>0);
...
OJPEGWriteHeaderInfo(TIFF* tif)
{
	...
	if ((sp->subsampling_force_desubsampling_inside_decompression==0) && (sp->samples_per_pixel_per_plane>1))
	{
		...
		if (sp->subsampling_convert_log==0)
		{
			...
			sp->subsampling_convert_ycbcrimage=_TIFFmalloc(sp->subsampling_convert_ycbcrimagelen*sizeof(TIFF_UINT8_T*));
			if (sp->subsampling_convert_ycbcrimage==0)
			{
				TIFFErrorExt(tif->tif_clientdata,module,"Out of memory");
				return(0);
			...
			*m++=(TIFF_UINT8_T*)(sp->subsampling_convert_ycbcrimage+3);
			*m++=(TIFF_UINT8_T*)(sp->subsampling_convert_ycbcrimage+3+sp->subsampling_convert_ylines);
			*m++=(TIFF_UINT8_T*)(sp->subsampling_convert_ycbcrimage+3+sp->subsampling_convert_ylines+sp->subsampling_convert_clines);
...
OJPEGReadHeaderInfoSecStreamDqt(TIFF* tif)
{
	...
	else
	{
		...
		do
		{
			...
			*(TIFF_UINT32_T*)nb=na;
			nb[sizeof(TIFF_UINT32_T)]=255;
			nb[sizeof(TIFF_UINT32_T)+1]=JPEG_MARKER_DQT;
			nb[sizeof(TIFF_UINT32_T)+2]=0;
			nb[sizeof(TIFF_UINT32_T)+3]=67;
			if (OJPEGReadBlock(sp,65,&nb[sizeof(TIFF_UINT32_T)+4])==0) {
				_TIFFfree(nb);
				return(0);
			}
			o=nb[sizeof(TIFF_UINT32_T)+4]&15;
			if (3<o)
			{
				TIFFErrorExt(tif->tif_clientdata,module,"Corrupt DQT marker in JPEG data");
				_TIFFfree(nb);
...
OJPEGReadHeaderInfoSecStreamDht(TIFF* tif)
{
	...
	else
	{
		...
		*(TIFF_UINT32_T*)nb=na;
		nb[sizeof(TIFF_UINT32_T)]=255;
		nb[sizeof(TIFF_UINT32_T)+1]=JPEG_MARKER_DHT;
		nb[sizeof(TIFF_UINT32_T)+2]=(m>>8);
		nb[sizeof(TIFF_UINT32_T)+3]=(m&255);
		if (OJPEGReadBlock(sp,m-2,&nb[sizeof(TIFF_UINT32_T)+4])==0)
			return(0);
		o=nb[sizeof(TIFF_UINT32_T)+4];
		if ((o&240)==0)
		{
			if (3<o)
			{
...
static int
OJPEGReadHeaderInfoSecStreamSof(TIFF* tif, TIFF_UINT8_T marker_id)
{
	...
	else
	{
		...
		if (OJPEGReadWord(sp,&p)==0)
			return(0);
		if (((TIFF_UINT32_T)p<sp->image_length) && ((TIFF_UINT32_T)p<sp->strile_length_total))
		{
		...
		if (OJPEGReadWord(sp,&p)==0)
			return(0);
		if (((TIFF_UINT32_T)p<sp->image_width) && ((TIFF_UINT32_T)p<sp->strile_width))
		{
			TIFFErrorExt(tif->tif_clientdata,module,"JPEG compressed data indicates unexpected width");
			return(0);
		}
		if ((TIFF_UINT32_T)p>sp->strile_width)
		{
...
OJPEGReadHeaderInfoSecTablesQTable(TIFF* tif)
{
	...
	for (m=0; m<sp->samples_per_pixel; m++)
	{
		if ((sp->qtable_offset[m]!=0) && ((m==0) || (sp->qtable_offset[m]!=sp->qtable_offset[m-1])))
		{
			...
			*(TIFF_UINT32_T*)ob=oa;
			ob[sizeof(TIFF_UINT32_T)]=255;
			ob[sizeof(TIFF_UINT32_T)+1]=JPEG_MARKER_DQT;
			ob[sizeof(TIFF_UINT32_T)+2]=0;
			ob[sizeof(TIFF_UINT32_T)+3]=67;
			ob[sizeof(TIFF_UINT32_T)+4]=m;
			TIFFSeekFile(tif,sp->qtable_offset[m],SEEK_SET); 
			p=TIFFReadFile(tif,&ob[sizeof(TIFF_UINT32_T)+5],64);
			if (p!=64)
				return(0);
			sp->qtable[m]=ob;
			sp->sof_tq[m]=m;
...
OJPEGReadHeaderInfoSecTablesDcTable(TIFF* tif)
{
	...
	for (m=0; m<sp->samples_per_pixel; m++)
	{
		if ((sp->dctable_offset[m]!=0) && ((m==0) || (sp->dctable_offset[m]!=sp->dctable_offset[m-1])))
		{
			...
			*(TIFF_UINT32_T*)rb=ra;
			rb[sizeof(TIFF_UINT32_T)]=255;
			rb[sizeof(TIFF_UINT32_T)+1]=JPEG_MARKER_DHT;
			rb[sizeof(TIFF_UINT32_T)+2]=((19+q)>>8);
			rb[sizeof(TIFF_UINT32_T)+3]=((19+q)&255);
			rb[sizeof(TIFF_UINT32_T)+4]=m;
			for (n=0; n<16; n++)
				rb[sizeof(TIFF_UINT32_T)+5+n]=o[n];
			p=TIFFReadFile(tif,&(rb[sizeof(TIFF_UINT32_T)+21]),q);
			if (p!=q)
				return(0);
			sp->dctable[m]=rb;
			sp->sos_tda[m]=(m<<4);
	...
	for (m=0; m<sp->samples_per_pixel; m++)
	{
		if ((sp->actable_offset[m]!=0) && ((m==0) || (sp->actable_offset[m]!=sp->actable_offset[m-1])))
		{
			...
			*(TIFF_UINT32_T*)rb=ra;
			...
			rb[sizeof(TIFF_UINT32_T)+2]=((19+q)>>8);
			rb[sizeof(TIFF_UINT32_T)+3]=((19+q)&255);
			rb[sizeof(TIFF_UINT32_T)+4]=(16|m);
			for (n=0; n<16; n++)
				rb[sizeof(TIFF_UINT32_T)+5+n]=o[n];
			p=TIFFReadFile(tif,&(rb[sizeof(TIFF_UINT32_T)+21]),q);
			if (p!=q)
...
OJPEGReadBufferFill(OJPEGState* sp)
{
	...
	do
	{
		if (sp->in_buffer_file_togo!=0)
		{
			...
			m=OJPEG_BUFFER;
			if ((TIFF_UINT64_T)m>sp->in_buffer_file_togo)
				m=(TIFF_UINT16_T)sp->in_buffer_file_togo;
			...
			assert(n<65536);
			assert((TIFF_UINT64_T)n<=sp->in_buffer_file_togo);
			m=(TIFF_UINT16_T)n;
			sp->in_buffer_togo=m;
...
static int
OJPEGReadByte(OJPEGState* sp, TIFF_UINT8_T* byte)
{
...
static int
OJPEGReadBytePeek(OJPEGState* sp, TIFF_UINT8_T* byte)
{
	if (sp->in_buffer_togo==0)
	{
		if (OJPEGReadBufferFill(sp)==0)
...
static int
OJPEGReadWord(OJPEGState* sp, TIFF_UINT16_T* word)
{
	TIFF_UINT8_T m;
	if (OJPEGReadByte(sp,&m)==0)
		return(0);
...
static int
OJPEGReadBlock(OJPEGState* sp, TIFF_UINT16_T len, void* mem)
{
	TIFF_UINT16_T mlen;
	TIFF_UINT8_T* mmem;
	TIFF_UINT16_T n;
...
static void
OJPEGReadSkip(OJPEGState* sp, TIFF_UINT16_T len)
{
	TIFF_UINT16_T m;
	TIFF_UINT16_T n;
	m=len;
	...
	if (m>0)
	{
		assert(sp->in_buffer_togo==0);
		n=m;
		if ((TIFF_UINT64_T)n>sp->in_buffer_file_togo)
			n=(TIFF_UINT16_T)sp->in_buffer_file_togo;
...
static int
OJPEGWriteStream(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	*len=0;
	do
...
static void
OJPEGWriteStreamSoi(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
...
static void
OJPEGWriteStreamQTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	if (sp->qtable[table_index]!=0)
	{
		*mem=(void*)(sp->qtable[table_index]+sizeof(TIFF_UINT32_T));
		*len=*((TIFF_UINT32_T*)sp->qtable[table_index])-sizeof(TIFF_UINT32_T);
	}
	sp->out_state++;
}

static void
OJPEGWriteStreamDcTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	if (sp->dctable[table_index]!=0)
	{
		*mem=(void*)(sp->dctable[table_index]+sizeof(TIFF_UINT32_T));
		*len=*((TIFF_UINT32_T*)sp->dctable[table_index])-sizeof(TIFF_UINT32_T);
	}
	sp->out_state++;
}

static void
OJPEGWriteStreamAcTable(TIFF* tif, TIFF_UINT8_T table_index, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	if (sp->actable[table_index]!=0)
	{
		*mem=(void*)(sp->actable[table_index]+sizeof(TIFF_UINT32_T));
		*len=*((TIFF_UINT32_T*)sp->actable[table_index])-sizeof(TIFF_UINT32_T);
	}
	sp->out_state++;
}

static void
OJPEGWriteStreamDri(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
...
static void
OJPEGWriteStreamSof(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	TIFF_UINT8_T m;
...
static void
OJPEGWriteStreamSos(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	TIFF_UINT8_T m;
...
static int
OJPEGWriteStreamCompressed(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	if (sp->in_buffer_togo==0)
	{
...
static void
OJPEGWriteStreamRst(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	assert(OJPEG_BUFFER>=2);
	sp->out_buffer[0]=255;
...
static void
OJPEGWriteStreamEoi(TIFF* tif, void** mem, TIFF_UINT32_T* len)
{
	OJPEGState* sp=(OJPEGState*)tif->tif_data;
	assert(OJPEG_BUFFER>=2);
	sp->out_buffer[0]=255;
...
#ifndef LIBJPEG_ENCAP_EXTERNAL
static int
jpeg_read_header_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, TIFF_UINT8_T require_image)
{
...
#ifndef LIBJPEG_ENCAP_EXTERNAL
static int
jpeg_read_scanlines_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* scanlines, TIFF_UINT32_T max_lines)
{
...
#ifndef LIBJPEG_ENCAP_EXTERNAL
static int
jpeg_read_raw_data_encap(OJPEGState* sp, jpeg_decompress_struct* cinfo, void* data, TIFF_UINT32_T max_lines)
{
