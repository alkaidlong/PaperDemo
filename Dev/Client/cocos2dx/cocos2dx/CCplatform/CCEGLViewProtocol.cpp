...
void CCEGLViewProtocol::setDesignResolutionSize(float width, float height, ResolutionPolicy resolutionPolicy)
{
    ...
    {
        m_fScaleX = m_fScaleY = CC_MAX(m_fScaleX, m_fScaleY);
    }
    
    if (resolutionPolicy == kResolutionShowAll)
    {
        m_fScaleX = m_fScaleY = CC_MIN(m_fScaleX, m_fScaleY);
    }
	...
	if (m_isCloseDisplayStats==false)
	{
...
void CCEGLViewProtocol::SetfScaleX( float x )
{
	m_fScaleX=x;
}

void CCEGLViewProtocol::SetfScaleY( float y )
{
	m_fScaleY=y;
}

void CCEGLViewProtocol::SetCloseDisplayStats(bool isClose)
{
	m_isCloseDisplayStats= isClose;
}
